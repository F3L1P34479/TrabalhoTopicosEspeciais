...
urlpatterns = [
    ...
    path('cadastrar/granjeiro/', GranjeiroCreate.as_view(),
         name="cadastrar-granjeiro"),
    path('cadastrar/proprietario/', ProprietarioCreate.as_view(),
    ...
    path('editar/tecnico/<int:pk>/',
         TecnicoUpdate.as_view(), name="editar-tecnico"),
    path('editar/granjeiro/<int:pk>/',
         GranjeiroUpdate.as_view(), name="editar-granjeiro"),
    path('editar/proprietario/<int:pk>/',
         ProprietarioUpdate.as_view(), name="editar-proprietario"),
    path('editar/racao/<int:pk>/', RacaoUpdate.as_view(), name="editar-racao"),
    path('editar/entrada/<int:pk>/',
         EntradaUpdate.as_view(), name="editar-entrada"),
    path('editar/matriz/<int:pk>/', MatrizUpdate.as_view(), name="editar-matriz"),
    path('editar/aviario/<int:pk>/',
         AviarioUpdate.as_view(), name="editar-aviario"),
    ...
    path('excluir/tecnico/<int:pk>/',
         TecnicoDelete.as_view(), name="excluir-tecnico"),
    path('excluir/granjeiro/<int:pk>/',
         GranjeiroDelete.as_view(), name="excluir-granjeiro"),
    path('excluir/proprietario/<int:pk>/',
         ProprietarioDelete.as_view(), name="excluir-proprietario"),
    path('excluir/racao/<int:pk>/', RacaoDelete.as_view(), name="excluir-racao"),
    path('excluir/entrada/<int:pk>/',
         EntradaDelete.as_view(), name="excluir-entrada"),
    path('excluir/matriz/<int:pk>/', MatrizDelete.as_view(), name="excluir-matriz"),
    path('excluir/aviario/<int:pk>/',
         AviarioDelete.as_view(), name="excluir-aviario"),
    ...
    # URLS de detalhes
    path('ver/aviario/<int:pk>/', AviarioDetalhes.as_view(),
         name="detalhar-aviario"),
]
